    ...
    return (
        <>
            ...
            <div id="terms-body">
                ...
                <p>
                    Welcome to my open-source and free-to-use CV maker website.
                    These terms and conditions outline the rules and regulations
                    for the use of my website.
                </p>
                <h2>Introduction</h2>
                <p>
                    ...
                    must not use my website.
                </p>
                <h2>License to use website</h2>
                <p>
                    This website is open-source and free-to-use. You are granted
                    a license to use, modify, and distribute the source code of
                    this website in accordance with the terms of the open-source
                    license under which it is released.
                </p>
                <p>You must not:</p>
                <ul>
                    <li>
                        use this website in any way that is unlawful, illegal,
                        fraudulent or harmful;
                    </li>
                    <li>
                        use this website to copy, store, host, transmit, send,
                    ...
                    <li>
                        ...
                        relation to this website without my express written
                        consent;
                    </li>
                    <li>
                        use data collected from this website for any direct
                ...
                <p>
                    ...
                    capable of giving rise to legal action whether against you
                    or us or a third party (in each case under any applicable
                    law).
                </p>
            </div>
            <Footer />
